...
{{--                                                    $disabled = $isRestricted && $existingPlan;--}}
{{--                                                @endphp--}}

{{--                                                <option value="{{ $schoolId }}" {{ $disabled ? 'disabled' : '' }}>--}}
{{--                                                    {{ $school->name }}--}}
                            ...
                            <div class="col-md-10">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-7">
                                            <label class="form-label" style="color: #1e0ace">المدرسة</label>
{{--                                            <select name="days[{{ $startOfMonth->format('Y-m-d') }}][schools][]" class="form-control custom-select" multiple>--}}
