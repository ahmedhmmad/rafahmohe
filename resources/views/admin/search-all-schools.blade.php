...
{{--                        <h2 class="p-4">مدرسة: <span class="text-primary">{{ $school->name }}</span></h2>--}}
{{--                        @if($plans->isEmpty())--}}
...
@section('content')
    <div class="p-2">
        ...
        <!-- Blade template code -->
        <div class="container py-2">
            <h2 class="p-4">المدارس المزارة</h2>
            @foreach($groupedPlans as $schoolId => $plans)
                @php
                    $school = $schools->find($schoolId);
                @endphp
                @if($school)
                    <span class="card px-2">
                        <h3 class="p-4">مدرسة: <span class="text-success">{{ $school->name }}</span></h3>
                        @if($plans->isEmpty())
                            <div class="p-4">لا توجد نتائج للبحث في هذا الشهر.</div>
                        @else
                            <table class="table">
            ...
            <h2 class="p-4">المدارس غير المزارة</h2>
            @foreach($unvisitedSchools as $unvisitedSchool)
                <span class="card px-2">
                    <h3 class="p-4">مدرسة: <span class="text-danger">{{ $unvisitedSchool->name }}</span></h3>
                    <div class="p-4">لا توجد زيارات لهذه المدرسة في هذا الشهر.</div>
                </span>
            @endforeach
        </div>
    </div>
