                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.apply-override-plan-restrictions') }}">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label for="can_override_current_week" class="form-label fw-bold">السماح باستثناء الأسبوع الحالي</label>
                                    <select name="can_override_current_week" id="can_override_current_week" class="form-control" required>
                                        <option value="1" {{ old('can_override_current_week') == '1' ? 'selected' : '' }}>نعم</option>
                                        <option value="0" {{ old('can_override_current_week') == '0' ? 'selected' : '' }}>لا</option>
                                    </select>
                                    @error('can_override_current_week')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                            </div>
