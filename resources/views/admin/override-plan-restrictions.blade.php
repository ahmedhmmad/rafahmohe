                    ...
                    <form method="POST" action="{{ route('admin.apply-override-plan-restrictions') }}">
                        ...
                        @elseif ($selectedUserOrDepartment == 'department')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="can_override_multi_department" class="form-label fw-bold">السماح باستثناء أكثر من قسم</label>
                                        <select name="can_override_multi_department" id="can_override_multi_department" class="form-control" required>
                                            <option value="0" {{ old('can_override_multi_department') == '0' ? 'selected' : '' }}>لا</option>
                                            <option value="1" {{ old('can_override_multi_department') == '1' ? 'selected' : '' }}>نعم</option>
                                        </select>
                                        @error('can_override_multi_department')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="mb-3">
